        ...
        <Row>
            <Col lg="6" md="6">
                <div className='hero__content'>
                    ...
                    <p>We combine current design trends with your brand’s identity and offer user-friendly websites solutions that appeal to the user. With our sectoral experience, we take steps in the light of technological developments and ensure that your brand targets are realized.</p>
                </div>
